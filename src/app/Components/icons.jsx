...
export const ImageBg = ({ className, ...rest }) => (
  <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">
        <stop id="stop1" stop-color="rgba(255, 0, 207.341, 1)" offset="0%"></stop>
        <stop id="stop2" stop-color="rgba(31, 91.124, 251, 1)" offset="100%"></stop>
      </linearGradient>
    </defs>
    <path fill="url(#sw-gradient)"
      d="M28.2,-17.9C36.2,-12.6,41.8,-0.9,39.4,8.6C36.9,18.1,26.3,25.4,15.8,29.1C5.3,32.7,-5.2,32.6,-13.3,28.4C-21.4,24.2,-27.1,15.8,-29.7,6.2C-32.4,-3.4,-32,-14.3,-26.5,-19.1C-21.1,-23.8,-10.5,-22.5,-0.2,-22.3C10.2,-22.2,20.3,-23.2,28.2,-17.9Z"
      width="8rem"
      height="8rem"
